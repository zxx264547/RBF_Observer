...
for num_centers = 1:max_centers
    ...
    for fold = 1:num_folds
        ...
        fault_sigma = ones(num_centers, 1) * mean(pdist(fault_centers));
        ...
        for iter = 1:num_iterations
            ...
            % 训练输出权重
            weights = pinv(G_train) * y_train_fault_fold;
...
fault_weights_optimal = pinv(G_train_optimal) * y_train_fault;
